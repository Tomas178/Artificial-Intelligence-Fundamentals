...
\input{2Lab/overleaf/sections/duomenys/tables/objektu_pasiskirstymas}
...
\begin{itemize}
    ...
    \item Validavimo aibė – naudojama neurono kokybei stebėti kiekvienos epochos pabaigoje. Padeda nustatyti geriausius parametrus bei pastebėti ar nevyksta persimokymas (angl.~\textit{Ovefitting}).
