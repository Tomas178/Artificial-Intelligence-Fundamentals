...
\begin{enumerate}
    ...
    \item Bendras eksperimentų vykdymo laikas CPU režimu siekė $1{,}42$ valandos. Vaizdams reikėjo taikyti pošalio (\textit{subset}) mechanizmą – be jo eksperimentų eiga būtų netilpusi į praktines laiko ribas.
