...
Skaičiavimo resursams taupyti įgyvendintas papildomas pošalio (\textit{subset}) mechanizmas: kiekvienos aibės dydis dauginamas iš parametro \texttt{subset\_ratio}, atrenkant atsitiktinius indeksus per \texttt{torch.randperm} su fiksuotu \textit{seed}. Hiperparametrų tyrimuose naudotas $\texttt{subset\_ratio} = 0{,}2$, o galutiniame geriausio modelio įvertinime – $\texttt{subset\_ratio} = 0{,}5$.
