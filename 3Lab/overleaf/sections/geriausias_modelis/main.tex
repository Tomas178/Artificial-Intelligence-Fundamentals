...
\begin{enumerate}
    \item Iš naujo apmoko tinklą $20$ epochų – vaizdams su didesniu poaibiu (\texttt{subset\_ratio}~$=0{,}5$, $2\,958$ vaizdai vietoj $1\,182$); laiko eilutėms aibė lieka ta pati.
...
\input{3Lab/overleaf/sections/geriausias_modelis/tables/best_model_summary}
