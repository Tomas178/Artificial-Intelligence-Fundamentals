...
\input{3Lab/overleaf/sections/duomenys/tables/keystroke_dynamics_pradiniai_duomenys}
\input{3Lab/overleaf/sections/duomenys/tables/keystroke_dynamics_stulpeliu_aprasymas}

Apibendrinta informacija apie laiko eilučių duomenų aibę pateikta \ref{tab:keystroke_suvestine} lentelėje.

\input{3Lab/overleaf/sections/duomenys/tables/keystroke_suvestine}