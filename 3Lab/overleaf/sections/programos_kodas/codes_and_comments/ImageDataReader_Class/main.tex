...
Klasė \texttt{ImageDataReader} užkrauna jau padalintas vaizdų aibes iš diske esančių aplankų ir pritaiko vienodą \texttt{torchvision.transforms} grandinę. Skaičiavimo resursams taupyti įgyvendintas pošalio (\textit{subset}) mechanizmas (žr.~\ref{fig:image_data_reader_class} pav.).
