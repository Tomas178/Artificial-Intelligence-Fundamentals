...
\begin{itemize}
    ...
    \item \texttt{evaluate\_best\_model} – iš naujo apmoko geriausią konfigūraciją su didesniu vaizdų pošaliu (\texttt{subset\_ratio}~$=0{,}5$), išsaugo galutines istorijos ir klasifikavimo matricos vizualizacijas, atspausdina $30$ testinių pavyzdžių spėjimus.
\end{itemize}
