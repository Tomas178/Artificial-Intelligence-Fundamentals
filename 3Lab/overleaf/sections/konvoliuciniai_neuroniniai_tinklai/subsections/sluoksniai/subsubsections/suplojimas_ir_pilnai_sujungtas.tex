...
\paragraph{Suplojimo sluoksnis.}
\texttt{Flatten} sluoksnis pertvarko daugiamačius požymių žemėlapius į vienmatį vektorių. Jis yra tiltas tarp konvoliucinės dalies (požymių išskyrimo) ir klasifikatoriaus (pilnai sujungtų sluoksnių). Sluoksnis neturi mokomų parametrų – jis tik pertvarko tensoriaus formą:
\begin{itemize}
...
\paragraph{Pilnai sujungtas sluoksnis.}
Pilnai sujungtas sluoksnis (angl.~\textit{fully connected layer}, \texttt{Linear}) sujungia kiekvieną įėjimo neuroną su kiekvienu išėjimo neuronu per mokomus svorius ir poslinkius. Projekte klasifikatorių sudaro du tokie sluoksniai:
\begin{enumerate}
